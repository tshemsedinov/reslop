...
const DARK_UI = {
  ...
  chipFg: [0x3a, 0x3a, 0x3a],
  chipBg: [0xff, 0xff, 0xff],
...
const LIGHT_UI = {
  ...
  chipFg: [0xff, 0xff, 0xff],
  chipBg: [0x24, 0x29, 0x2f],
...
const THEME = { ...DARK_UI };
const CODE_FG = { ...DARK_CODE };
const LOG_COL_FG = [...DARK_LOG_COLS];
...
const setTheme = (name) => {
  ...
  Object.assign(THEME, palette.ui);
  Object.assign(CODE_FG, palette.code);
  LOG_COL_FG.splice(0, LOG_COL_FG.length, ...palette.logCols);
  currentTheme = name;
};
