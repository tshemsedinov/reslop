...
const { MANIFEST, LOCKFILE, depFileMeta, relOf, listFilePath } = manifest;
...
const { diffSections, mergeResolved, summarizeGroup, collectGroups } = changes;
const { takeManifestItems, foldedDepNames, stripFoldedDepItem } = changes;
